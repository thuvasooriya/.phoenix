{lib, ...}: {
  services.skhd = {
    ...
    skhdConfig = ''
      ...
      ctrl - 1 : SPACES=($(yabai -m query --displays --display | jq '.spaces[]')) && [[ -n $SPACES[1] ]] && yabai -m space --focus $SPACES[1]
      ctrl - 2 : SPACES=($(yabai -m query --displays --display | jq '.spaces[]')) && [[ -n $SPACES[2] ]] && yabai -m space --focus $SPACES[2]
      ctrl - 3 : SPACES=($(yabai -m query --displays --display | jq '.spaces[]')) && [[ -n $SPACES[3] ]] && yabai -m space --focus $SPACES[3]
      ctrl - 4 : SPACES=($(yabai -m query --displays --display | jq '.spaces[]')) && [[ -n $SPACES[4] ]] && yabai -m space --focus $SPACES[4]
      ...
      ctrl - "right" : osascript -e 'display notification "Lorem right" with title "right"'
      ctrl - "left" : osascript -e 'display notification "Lorem left" with title "left"'
